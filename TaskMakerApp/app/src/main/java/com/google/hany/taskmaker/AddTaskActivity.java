...
public class AddTaskActivity extends AppCompatActivity implements
    ...
    protected void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putCharSequence(FORMATDDATE, mDueDateView.getText());
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        mDueDateView.setText(savedInstanceState.getCharSequence(FORMATDDATE));
    }
    ...
    private void updateDateDisplay() {
        if (getDateSelection() == Long.MAX_VALUE) {
            ...
            formatted = DateUtils.getRelativeTimeSpanString(this, mDueDate);
